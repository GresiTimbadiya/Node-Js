...
module.exports.loginPage = (req, res) => {
    try {
        if (req.cookies.admin_matrix == undefined || req.cookies.admin_matrix._id == undefined) {
...
module.exports.loginAdmin = async (req, res) => {
    try {
        let singleAdmin = await adminModel.findOne({ email: req.body.email });
        if (singleAdmin) {
            let matchPassword = await bcrypt.compare(req.body.password, singleAdmin.password);
            if (matchPassword) {
                res.cookie("admin_matrix", singleAdmin);
